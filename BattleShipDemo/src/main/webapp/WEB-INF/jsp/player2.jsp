...
<body>
	...
	<form action="/addPlayer2" method="get">
		...
		Player Name : <input type="text" name="player1" required="required" placeholder="Player 2 name"> <br>
		...
		<br> Type for battleship 1: <select name="shipP">
			...
			style="width: 15px" required="required"> * <input type="text" name="shipp1Height"
			style="width: 15px" required="required"><br>
		<br> Location of battleship 1 for player B: <select name="setShipP"
			style="width: 50px" >
			...
			style="width: 15px"> <br>
		<br> SetShip in BattleField :<select name="setShipQ"
			style="width: 50px">
		...
		Missile targets for player 2: <input type="text" name="missiles" placeholder="Missile Target Location" required="required">Note:Required Format(Eg: A1,A2,A3)
		<br>
		<br>
